...
import {Button, ButtonImperativeHandlers} from "../Button";
...
export const SelectDrop = React.forwardRef<SelectDropImperativeHandlers, SelectDropProps>((_props, ref) => {
    ...
    return (
        <div
            ref={containerRef}
            className={classNames(className, "bbuutoonn-select-drop", {
                'bbuutoonn-select-drop_open': open || _open,
            })}
        ...
        >
            <Button
                ...
                className={"bbuutoonn-select-drop__value"}
            ...
            <SelectButtons
                ...
                className={"bbuutoonn-select-drop__items"}
            />
        </div>
    );
});
